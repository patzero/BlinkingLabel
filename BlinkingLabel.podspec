...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'BlinkingLabel framework tuto cocoapods testing'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/patzero/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Weeraphat Kaewnang' => 'weeraphat@databerries.com' }
  s.source           = { :git => 'https://github.com/Weeraphat Kaewnang/BlinkingLabel.git', :tag => s.version.to_s }
